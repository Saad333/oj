...
<div class="container">
		...
		if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['privilage'] < 9)
		{
			if (isset($_POST['submit'])){
	            ...
	            if ($result) {
	                ...
	                redirect_to("http://localhost/ojtest/modules/problems.php");
	            } else {
	                // Failure
	                $_SESSION["message"] .= "Problem creation failed . ";
	                redirect_to("http://localhost/ojtest/modules/add_new_program.php");
	            }
	...
	?>		
			...
			<form class="form-horizontal" role="form" action="http://localhost/ojtest/modules/add_new_program.php" method="post" enctype="multipart/form-data">
