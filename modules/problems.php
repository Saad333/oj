	...
	<?php 
		...
		if (isset($_GET['id']))
		{
		    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
	            echo '<div class="container ">';
					echo '<a href="http://localhost/ojtest/temp_code/submit.php?id='. $_GET['id'] .'" class="btn btn-secondary" style="border: 1px solid #13a22b;">Submit</a>';
	            echo "</div><br>";
	        } 
	        $prob_id = $_GET['id'];
		...
		else
		{
			if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['privilage'] < 9) {
	            echo '<div class="container ">';
					echo '<a href="http://localhost/ojtest/modules/add_new_program.php" class="btn btn-secondary" style="border: 1px solid #13a22b; margin-right:15px;">Add new problem</a><a href="http://localhost/ojtest/modules/edit_program.php" class="btn btn-secondary" style="border: 1px solid #13a22b;">Edit problem</a>';
	            echo "</div><br>";
			                    ...
			                    <?php
			                    	...
			                    	foreach ($r_array as $key => $value) {
			                    		...
			                    		echo '<div class="row list-group-item panel-success" style="margin-right: 0px;margin-left: 0px;padding: 5px 15px;">';
				                    		echo '<a href="http://localhost/ojtest/modules/problems.php?id='. $value['id'] .'"><div class="col-xs-2">'. $i .'</div></a>';
					                    	echo '<a href="http://localhost/ojtest/modules/problems.php?id='. $value['id'] .'"><div class="col-xs-4">'. $value['name'] .'</div></a>';
